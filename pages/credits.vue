    ...
    <div class="px-5-mobile mt-6 light">
      <div class="columns mb-6">
        <div class="column is-three-fifths is-offset-one-fifth">
          <div class="content is-size-5">
            <p>
              Northern Climate Reports would not be possible without
              contributions from a wide variety of climate science
              professionals. These include ecosystem modelers and boreal
              ecologists who interpret and look for patterns in massive amounts
              of data, plus geospatial data analysts and software developers who
              verify the data and create visualizations that aid understanding.
              Science communicators and administrative staff round out the team,
              using graphic design, writing, and organizational skills to help
              this tool work for a wide variety of users.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="person mt-5 columns">
        ...
        <div class="column is-5">
          ...
          <div class="content is-size-5">
            <p>
              Dr. Amy Breen is an expert in Arctic vegetation ecology, short-
              and long-term effects of climate change and disturbance on
              vegetation. Her research interests include field studies and
              modeling to understand and forecast changes in Arctic terrestrial
              ecosystems, particularly the response of vegetation to disturbance
              and climate change.
            </p>
            <p>
        ...
        <div class="column is-5">
          ...
          <div class="content is-size-5">
            ...
            <p>
              ...
              America's forests. His doctoral work at the University of
              Washington focused on ecological and climatic controls on wildfire
              in the western US and the role of climate in Douglas-fir tree
              growth across its climatic range. He also worked as a research
              scientist at the University of Washington Climate Impacts Group,
              collaborating with resource managers in federal and state agencies
              to better understand and use climate information in planning and
              adaptation.
            </p>
            <p>
        ...
        <div class="column is-5">
          ...
          <div class="content is-size-5">
            ...
            <p>
              ...
              Fresco’s work focuses on connecting northern climate data and
              model projections to the real-world needs, concerns, and questions
              of those who live and work here.
            </p>
            <p>
              Nancy works closely with SNAP&rsquo;s programmers, spatial
              analysts, and communications experts to create resources to aid in
              adaptation planning.
            </p>
            <p>
        ...
        <div class="column is-5">
          ...
          <div class="content is-size-5">
            <p>
              ...
              Geophysical Institute. Sergey does research in numerical modeling
              of permafrost dynamics, climate-permafrost interactions, and the
      ...
      <div class="person mt-5 columns">
        ...
        <div class="column is-5">
          ...
          <div class="content is-size-5">
            ...
            <p>
              Dr. Rupp has more than 27 years of experience in ecosystem
              modeling and climate change/climate impacts science. Recent work
              has focused on modeling the response of subarctic and arctic
              ecosystems to changes in global climate and disturbance regimes.
              Dr. Rupp served as a member (2016–2017) of the Federal Advisory
            ...
            <p>
              ...
              University of Alaska Fairbanks. He is Professor of Forestry and
              has been a faculty member at UAF since 2001.
            </p>
            <p>
        ...
        <div class="column is-5">
          ...
          <div class="content is-size-5">
            ...
            <p>
              ...
              vulnerabilities, downscaling models and more. His research has
              long focused on Arctic sea ice, and he worked to establish the
              Historical Sea Ice Atlas, a long-term database of sea ice levels
              back to the 1850s.
            </p>
            <p>
              ...
              extensive scientific publications, Walsh has regularly served as
              an author or editor of official climate reports such as the Arctic
              Extreme Events chapter of AMAP's Climate Update report (2021) and
              a new Report Card section on Arctic Precipitation in the BAMS
              State of the Climate (2022).
            </p>
            <p>
              The official assessment efforts to which John has contributed
              serve to evaluate, integrate, and communicate recent science
              research, primarily for public leaders and decision makers. He has
              aimed to provide a balanced perspective on Alaska’s recent changes
              in the face of both growing interest and comparatively sparse data
        ...
        <div class="column is-three-fifths is-offset-one-fifth">
          ...
          <h4 class="title is-4 mt-6">Rasdaman raster database</h4>
            ...
            <p>
              ...
              management system. This technology enables our team to store,
              analyze and visualize the 5+ TB of climate data that are presented
              through this interface. We wish to thank the rasdaman project and
              team for their inspiration and support, and for providing this
              important innovation in data technology.
            </p>
            <blockquote>
              Peter Baumann, email: p.baumann@jacobs-university.de, & website:
              rasdaman.org. (2018). rasdaman - raster data manager (9.5.0).
              Zenodo.
